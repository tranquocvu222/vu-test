package com.nals.auction.aop.logging;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(com.nals.auction.repository..*)"
        + " || within(com.nals.auction.service..*)"
        + " || within(com.nals.auction.bloc..*)")
    ...
    public Object logAround(final ProceedingJoinPoint joinPoint)
        ...
        if (log.isDebugEnabled()) {
            log.debug("Enter: {}() with argument[s] = {}", joinPoint.getSignature().getName(), Arrays
